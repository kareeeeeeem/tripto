...
<<<<<<< HEAD
  ...
  String get cancellation3 =>
      'أهلاً بك في [TripTo]. نحن نسعى لتقديم تجربة حجز شفافة وعادلة. توضح هذه السياسة \'السياسة\' الشروط والأحكام المتعلقة بعمليات الإلغاء واسترداد المبالغ المدفوعة للخدمات المحجوزة عبر تطبيقنا، والتي تشمل على سبيل المثال لا الحصر: حجوزات الطيران، الإقامات الفندقية، باقات العطلات، الجولات السياحية، والأنشطة الترفيهية ';

  @override
  String get cancellation4 =>
      'إن إتمام الحجز عبر [ Ttipto] يعني موافقتك على هذه السياسة وعلى شروط وأحكام مزود الخدمة النهائي (مثل شركة الطيران، الفندق، منظم الرحلات).';
  ...
  String get cancellation6 =>
      'تخضع سياسة الإلغاء والاسترداد بشكل أساسي للشروط التي يضعها مزود الخدمة النهائي. يعمل [Tripto] كوسيط، وسنقوم بعرض شروط الإلغاء الخاصة بكل حجز بوضوح تام أثناء عملية الحجز وقبل إتمام عملية الدفع.';
