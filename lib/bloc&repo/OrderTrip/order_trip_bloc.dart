...
class OrderTripSearcMyTripsBloc extends Bloc<OrderTripSearcMyTripsEvent, OrderTripSearcMyTripsState> {
  final OrderTripSearcMyTripsRepository repository;

  OrderTripSearcMyTripsBloc(this.repository) : super(OrderTripSearcMyTripsInitial()) {
